---
title: 18 Mistakes that kill Startups
tags:
  - Entrepreneur
categories:
  - Money_経済
...
sourceUrl: http://www.paulgraham.com/startupmistakes.html
sourceAuthor: Paul GRAHAM
sourceAuthorImg: false
sourcePublishDate: 2006-10-30
img: /2022/0802/Money_経済/18-Mistakes-that-kill-Startups/18-mistakes-that-kill-startups-PG-infographic.png
openGraph_img: /2022/0802/Money_経済/18-Mistakes-that-kill-Startups/18-mistakes-that-kill-startups-PG-infographic.png
date: 2022-08-02 16:11:22
updated: 2022-08-02 16:11:22
excerpt: Asking how to make a startup succeed — if you avoid every cause of failure, you succeed — and that's too big a question to answer easily.
---
...
![](./18-Mistakes-that-kill-Startups/18-mistakes-that-kill-startups-PG-infographic.png)
...
Because making something people want is so much harder than making money from it, you should leave business models for later, just as you'd leave some trivial but messy feature for version 2. In version 1, solve the core problem. And the core problem in a startup is how to [create wealth](http://www.paulgraham.com/wealth.html) (= how much people want something x the number who want it), not how to convert that wealth into money.
...
## Translations
{% linkgroup %}
{% link `日本語`, http://www.aoky.net/articles/paul_graham/startupmistakes.htm %}
{% link `العربية`, https://chefrour.blogspot.com/2020/10/18.html %}
{% link `中文`, http://www.yeeyan.com/articles/view/little/114 %}
{% link `Istroromånă`, http://ro.goobix.com/pg/startupmistakes/ %}
{% link `Español`, http://gasparolo.com/gabriel/?p=108 %}
{% endlinkgroup %}


## Related
{% linkgroup %}
{% link `6 Mistakes to Avoid When Building a Business Website`, /2022/0609/Money_経済/6-mistakes-to-avoid-when-building-a-business-website.html %}
{% link `Biggest Mistake Smart People Make When Building Startups`, /2022/0403/Money_経済/Biggest-Mistake-Smart-People-Make-When-Building-Startups.html %}
{% link `9 Confessions From a Failed Startup CEO`, /2022/0220/Money_経済/9-Confessions-From-a-Failed-Startup-CEO.html %}
{% endlinkgroup %}